...
Console.WriteLine("Enter edges in format: <from node> - <to node>. NOTE: nodes numbers in range [0..nodes.Length - 1]");
...
Console.WriteLine(PathFinder.FindLongestPath(graph));